        ...
        <div className = "container ">
            ...
            <div className="md:hidden p-5 gap-10 pt-16">
                <div className="flex gap-3 pb-6">
                    ...
                    <p className="text-xs font-normal text-gray-500 pb-5">Here is a link to our associated GitHub repository :) we hope you like our code.</p>
                    <a className="cursor-pointer ">
                ...
                <div className="flex flex-row gap-3">
                    <div className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 ">
                    <h5 className="mb-2 text-md font-bold tracking-tight text-gray-900 ">Risk assessment and mitigation </h5>
